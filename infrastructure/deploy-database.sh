...
echo "🗄️ Deploying PostgreSQL Database on GCP..."
echo "==============================================="
...
echo "📦 Creating Cloud SQL PostgreSQL instance (private)..."
...
echo ""
echo "🚀 Next: Deploy self-hosted Supabase on Cloud Run to connect to this database"